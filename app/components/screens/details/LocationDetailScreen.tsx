...
export default function LocationDetailScreen() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="sticky bg-white border-b border-gray-200 p-4 z-10" style={{ top: 'env(safe-area-inset-top, 0px)' }}>
      ...
      {/* Location Info */}
      <div className="bg-white p-6 border-b border-gray-200" style={{ paddingTop: 'calc(64px + env(safe-area-inset-top, 0px))' }}>
